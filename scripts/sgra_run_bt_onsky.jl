...
@everywhere function parsim(dir, outdir, model; tmin=12.455, tmax=14.2, kwargs...)
    ...
    pmap(files) do f
        ...
        singlescan_vacp(f, outdir, scan, model; tmin, tmax, kwargs...)
        GC.gc()
    end
end
